...
export function DealerNFTSelector({ tokenIds, selectedTokenId, onSelect }: DealerNFTSelectorProps) {
  ...
  return (
    <div className="md:w-44">
      ...
      <Select
        value={selectedTokenId !== undefined ? String(selectedTokenId) : undefined}
